package com.stresswatch.ai.ui.settings
...
import com.stresswatch.ai.databinding.FragmentSettingsBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.seekbarThreshold.setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener {
            override fun onProgressChanged(sb: SeekBar?, progress: Int, fromUser: Boolean) {
                binding.tvThresholdValue.text = "Alert at score: $progress"
            }
